...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("CHAOSSHOWCASE", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("CHAOSSHOWCASE", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "CHAOSSHOWCASE";
		app.meta["name"] = "CHAOSSHOWCASE";
		app.meta["packageName"] = "com.sample.chaosshowcase";
